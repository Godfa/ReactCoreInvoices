...
export default function InvoiceDashboard({ invoices, selectedInvoice, selectInvoice
    , cancelSelectInvoice, editMode, openForm, closeForm, createOrEdit, deleteInvoice }: Props) {
    return (
        <Grid>
            <Grid.Column width={'8'}>
            ...
            <Grid.Column width='8'>
                {selectedInvoice && !editMode &&
                    ...
                    />}
                {editMode &&
                    <InvoiceForm closeForm={closeForm} invoice={selectedInvoice} createOrEdit={createOrEdit}/>}
            </Grid.Column>
        </Grid>
    )
}